...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2022 at 01:44 PM
...
INSERT INTO `acounts` (`id`, `phone_number`, `full_name`, `password`, `email`, `is_active`, `is_deleted`, `photo`) VALUES
(0, '(898) 388-9426', 'Jerome Gipson', '1kOwmq+6of12T1MG7flbzg==', 'Hoover@example.com', 0, 0, '367J68H58J9493Q4OW5W9H7W01EWCTQ3Q06829O6NJJ937LQX4M9S3W5ML6QB4922R6EGRC1J5TUCI1D'),
(1, 'admin', 'Letha Bolt', '$2a$10$2S3lxVrNH8E4Wno8kbhpm.HYBq4k7HqVMqQ/eCtkUpqeuc6cER4iq', 'Bolt@nowhere.com', 1, 0, '00A848KWUQ74'),
(2, 'super_admin', 'Vanita Kelleher', '$2a$10$2S3lxVrNH8E4Wno8kbhpm.HYBq4k7HqVMqQ/eCtkUpqeuc6cER4iq', 'Morehead@example.com', 1, 0, 'T3NO40JEX3LQ8SI15W4575'),
(3, 'custommer', 'Marcos Abraham', '$2a$10$2S3lxVrNH8E4Wno8kbhpm.HYBq4k7HqVMqQ/eCtkUpqeuc6cER4iq', 'qpzre411@example.com', 1, 0, 'I52'),
(4, 'lock', 'Miyoko Mckinney', '$2a$10$2S3lxVrNH8E4Wno8kbhpm.HYBq4k7HqVMqQ/eCtkUpqeuc6cER4iq', 'Bray162@example.com', 0, 0, '7T'),
...
INSERT INTO `cart_items` (`id`, `quantity`, `product_detail_id`, `acount_id`) VALUES
(1, -8022, 46, 1),
(2, -617853697, 44, 1),
(3, -611296160, 26, 1),
(4, -1529059329, 33, 1),
...
INSERT INTO `orders` (`id`, `address`, `address_detail`, `time_create`, `staff_id`, `delivery_cost`, `return_order`, `status`, `id_acount`, `full_name`, `phone_number`) VALUES
...
INSERT INTO `products` (`id`, `product_name`, `description`, `is_deleted`, `category_id`, `image`) VALUES
...
CREATE TABLE `product_images` (
  `id` int(11) NOT NULL,
  `name_image` varchar(500) DEFAULT NULL,
  `id_Product_Detail` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `cart_items`
  ...
  ADD KEY `cart_items_ibfk_2` (`acount_id`);
...
--
-- AUTO_INCREMENT for table `favories`
--
ALTER TABLE `favories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
-- AUTO_INCREMENT for table `role_acount`
--
ALTER TABLE `role_acount`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `cart_items`
  ...
  ADD CONSTRAINT `cart_items_ibfk_2` FOREIGN KEY (`acount_id`) REFERENCES `acounts` (`id`);
