...
INSERT INTO `history_` (`id`, `date_create`, `order_id`, `description`) VALUES
...
ALTER TABLE `detail_products`
  ...
  ADD CONSTRAINT `detail_products_ibfk_3` FOREIGN KEY (`id_size`) REFERENCES `` (`id`);

--
-- Constraints for table ``
--
ALTER TABLE ``
  ADD CONSTRAINT `_ibfk_1` FOREIGN KEY (`product_detail_id`) REFERENCES `detail_products` (`id`),
  ADD CONSTRAINT `_ibfk_2` FOREIGN KEY (`sale_Event_id`) REFERENCES `sale_events` (`id`);
